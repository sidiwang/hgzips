...
DSHZINB_one_gamma = DataSquashingHZINB_one_gamma(K = 10, L = 10, H = 10, grid = grid, init_pi_klh = rep(0.001, 1000), N_ij_squashed = N_ij_squashed, iteration = 15, Loglik = TRUE)

theta_EM = DSHZINB_one_gamma$theta_EM
Loglik = DSHZINB_one_gamma$Loglik
