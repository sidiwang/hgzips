...
DSZINB_two_gamma_result = DataSquashingZINB_two_gamma(alpha1 = 0.2, beta1 = 0.1, alpha2 = 2, beta2 = 4, pi = 0.33, omega = 0.3, N = squashed$N, E = squashed$E, weight = squashed$weight, iteration = 50, Loglik = TRUE)
theta_EM = DSZINB_two_gamma_result$theta_EM
Loglik = DSZINB_two_gamma_result$Loglik
