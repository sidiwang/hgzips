#' HGZIPS - Data Squashing ZINB (mixture of two gamma)
#'
...
#' @param squashedData the dataset of squashed N_ij, E_ij and weights. This dataset can be generated by the rawProcessing function in this package.
...
DataSquashingZINB_two_gamma = function(alpha1, beta1, alpha2, beta2, pi, omega, squashedData, iteration, Loglik){
