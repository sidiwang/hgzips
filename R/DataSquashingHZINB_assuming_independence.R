#' HGZIPS - Data Squashing HZINB ( assuming independence)
#'
...
#' @param N_ij_squashed a list of squashed datasets that include N_ij, E_ij and weights for each drug (j). This dataset list can be generated by the rawProcessing function in this package.
...
#' @rdname DataSquashingHZINB_assuming_independence
...
#' DataSquashingHZINB_one_gamma_assuming_independence
#' @export
#'
DataSquashingHZINB_one_gamma_assuming_independence = function(grid_a, grid_b, grid_omega, init_pi_k, init_pi_l, init_pi_h, N_ij_squashed, iteration, Loglik){
  ## EM algorithm
